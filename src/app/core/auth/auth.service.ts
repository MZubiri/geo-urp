...
export class AuthService {
  ...
  register(payload: any): Observable<any> {
    return this.http.post<any>(`/api/v1/auth/register`, payload);
  }

  getMyProfile(): Observable<any> {
    return this.http.get<any>(`/api/v1/auth/my-profile`, {
      headers: this.authHeaders(),
    });
  }

  updateProfile(payload: any): Observable<any> {
    return this.http.put<any>(`/api/v1/auth/my-profile`, payload, {
      headers: this.authHeaders(),
    });
  }
  ...
  uploadProfilePhoto(file: File): Observable<any> {
    ...
    return this.http.post<any>(`/api/v1/auth/my-profile/upload-photo`, formData, {
      headers: this.authHeaders(),
    });
  }
  ...
  canApproveRegistrations(): boolean {
    return this.getBooleanClaim(['geo_can_approve_registrations']);
  }
