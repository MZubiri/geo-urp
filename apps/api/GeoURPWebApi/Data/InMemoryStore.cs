...
public sealed class InMemoryStore
{
    ...
    [
        new User { Id = 1, Name = "Administrador", Email = "admin@geourp.local", Password = "SET_LOCAL_PASSWORD_HASH", Roles = ["Admin"] },
        new User { Id = 2, Name = "Editor", Email = "editor@geourp.local", Password = "SET_LOCAL_PASSWORD_HASH", Roles = ["Editor"] }
    ];
